...
public class TodolistApplication {
	...
	public CommandLineRunner initData(UserRepository userRepository, TaskRepository taskRepository) {
		...
		return args -> {
			UserEntity user = new UserEntity("pepe", passwordEncoder.encode("pepe123"), "pepe@pepe.com");
			UserEntity user1 = new UserEntity("fulano", passwordEncoder.encode("fulano123"), "fulano@fulano.com");
			UserEntity user2 = new UserEntity("juan", passwordEncoder.encode("juan123"), "juan@juan.com");
